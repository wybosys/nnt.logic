...
<script>
    ...
    import {api, models, routers} from "../../../../bin/contrib/manager/api/api"
    ...
    export default {
        ...
        created() {
            Session.SID = localStorage.getItem("::manager::sid");
        ...
        methods: {
            ...
            actSubmit(e) {
                ...
                if (tmp instanceof models.Paged) {
                    ...
                    Session.Fetch(tmp, () => {
                        if (tmp instanceof models.MgrLogin && tmp.sid) {
                            Session.SID = tmp.sid;
                            localStorage.setItem("::manager::sid", tmp.sid);
                        }
                        let res = Output(tmp);
                        this.outputs = res;
                    }, err => {
